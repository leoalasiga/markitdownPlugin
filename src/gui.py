...
class ConverterApp:
    ...
    def _build_execution_section(self, parent: ttk.Frame) -> None:
        ...
        self.log_text = Text(frame, height=15, wrap="word", state=DISABLED)
        self.log_text.pack(fill=BOTH, expand=True)
        self._append_log("Ready. Add .doc or .docx files, choose an output folder if needed, then start conversion.")
